...
export const ClientStatsProvider = ({ children }) => {
    ...
    const getProxiedImage = (src) => {
        ...
        // Proxy Instagram/Facebook/Google/YouTube thumbnails to avoid expired signed URLs and origin blocks
        if (low.includes("fbcdn.net") || low.includes("instagram.com") || low.includes("cdninstagram.com") || low.includes("fbsbx.com") || low.includes("googleusercontent.com") || low.includes("ggpht.com") || low.includes("ytimg.com") || low.includes("i.ytimg.com") || s.includes("efg=")) {
