            ...
            {items.map((g) => (
              ...
              >
                <div
                  ...
                  style={{
                    aspectRatio: g.ratio === "1/1" ? "1 / 1" : "9 / 16",
                  }}
                >
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(135deg, rgba(232,80,2,.20), rgba(232,80,2,.06))",
                    }}
                  />
                  <div
                ...
                <div className="p-3 sm:p-4">
                  ...
                  <div className="mt-3">
                    <button
                      className="px-3 py-1.5 rounded-lg text-white text-xs md:text-sm w-full sm:w-auto"
          ...
          >
            ...
            >
              ...
              <p className="font-medium">
                Need a week of Shorts ready to post?
              </p>
            </div>
