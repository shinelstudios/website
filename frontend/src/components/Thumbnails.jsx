      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
        <div>
          ...
          <p className="mb-6" style={{ color: "rgba(255,255,255,0.7)" }}>
            Scroll-stopping thumbnails designed to boost CTR and brand recognition.
          </p>
...
/* ===================== Page Content ===================== */
const thumbItems = Array.from({ length: 9 }).map((_, i) => ({
  id: i + 1,
  title: `Thumbnail ${i + 1}`,
  desc: "Eye-catching, brand-true thumbnail.",
  tag: ["Gaming", "Education", "Tech", "Lifestyle", "Shorts"][i % 5],
}));
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl">
            ...
            <div className="mt-6 flex flex-wrap gap-2">
              {["Gaming", "Education", "Tech", "Lifestyle", "Shorts"].map((t) => (
                <Tag key={t}>{t}</Tag>
              ))}
            </div>
          </div>
