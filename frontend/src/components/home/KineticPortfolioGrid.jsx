...
// Using the .webp variants (auto-generated by scripts/images-to-webp.js)
// instead of .jpg cuts the bundled hero asset weight from ~9 MB → ~2 MB
// (per Lighthouse "improve image delivery" — the single biggest perf
// win on the home page).
import BGMI_1 from "../../assets/bgmi-thumbnail-creator1.webp";
import BGMI_2 from "../../assets/bgmi-thumbnail-creator2.webp";
import BGMI_3 from "../../assets/bgmi-thumbnail-creator3.webp";
import BGMI_4 from "../../assets/bgmi-thumbnail-creator4.webp";
import VLOG_AFTER from "../../assets/Vlog_sample_after.webp";
...
export default function KineticPortfolioGrid() {
  ...
  return (
    <div ref={gridRef} className="flex flex-col gap-3 md:gap-4">
      {/* Featured 16:9 hero — `priority` enables eager + fetchpriority=high
          so this image becomes the LCP candidate. Past behaviour was
          loading="lazy" on every tile including the hero, which made
          Lighthouse return NO_LCP on desktop and pushed mobile LCP to
          5.9 s (the lazy load eventually fired but late). */}
      <Tile
        item={tiles[0]}
        peek={peekIdx === 0}
        size="hero"
...
function Tile({ item, peek, size, fallbackIdx, priority = false }) {
