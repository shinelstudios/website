...
1.  **The 3-Second Rule (Revised)**: Instead of a loud scream, open with a **visual curiosity gap**. Show, don't just yell.
2.  **Audio Dynamics**: Use silence as a weapon. If the music never stops, it loses its power. Drop the track completely for your most important punchline.
3.  **Pattern Interrupts**: Use B-roll that contrasts the A-roll in tone, not just content. If you're talking fast, cut to slow-motion footage.
